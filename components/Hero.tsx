...
function Hero() {
  return (
    <header className="flex flex-col bg-hero bg-center bg-cover bg-no-repeat sm:p-16 py-16 px-8  justify-center lg:items-center max-lg:flex-col w-full sm:gap-16 gap-0">
      <ModeToggle/>
